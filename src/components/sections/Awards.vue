  ...
  "en": {
    ...
    "awards": {
      "climateGrant": {
        ...
        "prize": "min. 10.000 EUR Total Grant budget",
        "description": "The three projects best evaluated by the jury win a project grant with which the team can turn its idea into reality."
      },
      "cityPrize": {
        "title": "City Prizes",
  ...
  "de": {
    ...
    "awards": {
      "climateGrant": {
        ...
        "prize": "min. 10.000 EUR gesamtes Förderbudget",
        "description": "Die drei von der Jury am besten bewerteten Projekte erhalten einen Projektstipendium, mit dem das Team seine Idee in die Tat umsetzen kann."
      },
      "cityPrize": {
        "title": "Stadtpreise",
