    ...
    <v-container>
      ...
      <v-layout
        ...
        <v-flex
          ...
          <p :style="{ color: member.orgColor }" class="member-organisation my-1">{{ member.organisation }}</p>
          <p class="member-description my-1">{{ $i18n.locale === "en" ? member.i18nDescription[0] : member.i18nDescription[1] }}</p>
        </v-flex>
      </v-layout>
    </v-container>
  </section>
