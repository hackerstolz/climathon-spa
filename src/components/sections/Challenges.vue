          ...
          challenges: [
            {
              ...
              i18nSummary: [
                "Everybody should plant at least one tree in his lifetime. BOS wants to set up platform that makes it a real joy to plant trees in Indonesian rainforest. A transparent and individual way to donate new forest -tree by tree. Creating habitat for orangutans and many other endangered species while at the same time helping to turn the lever on climate change by saving a vast peat swamp.",
