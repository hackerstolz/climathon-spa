          ...
          challenges: [
            {
              ...
              i18nSummary: [
                ...
                "Fossil Free Karlsruhe ist eine regionale NGO und hat in der Stadt Karlsruhe die Initiative FAKTOR2 gestartet. Die wichtigsten Inhalte sind in der WEBsite unter: <a class='link' target='_blank' href='www.faktor2.solar'>www.faktor2.solar</a><br/>Fossil Free Karlsruhe will die Bewohner mit FAKTOR2 und der Frage herausfordern: \"Wie lange braucht die Stadt, bis sich die installierte kWpeak Leistung (Spitzenleistung) auf den Dächern verdoppelt hat?\" FAKTOR2 sammelt alle Akteure der Stadt und bildet eine breite Koalition, um die Bewohner zu motivieren, eine Solaranlage auf ihren Dächern zu installieren. Für Fossil Free Karlsruhe steht fest: Das Potenzial der Initiative ist groß genug, um FAKTOR2 überregional zu starten. Deshalb will Fossil Free Karlsruhe einen Werbevideo-Clip in die Kinos bringen, um die Menschen für FAKTOR2 landesweit zu begeistern. Der Videoclip beinhaltet einen CrashTest mit 2 Dummies, die sich auf dem Weg in Richtung Betonwand bewusst werden, dass ihr Leben in wenigen Sekunden endet. Aber anstatt sofort zu bremsen, achten die beiden Tester lieber darauf, ihre Tasse Kaffee nicht zu vergießen: \"Wenn du jetzt Pause machst, verschütte ich meinen Kaffee.\" Fossil Free Karlsruhe will mit diesem Clip die Aufmerksamkeit einer breiten Einwohnerschaft auf die Klimakatastrophe lenken und aktiv dagegen vorgehen."
              ],
              i18nDescription: [
