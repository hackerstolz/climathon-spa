      ...
      faqs: [
        ...
        },
        {
          ...
          i18nText: [
            ...
            "<strong>Berechtigung</strong><ul><li>Teilnehmer aus allen Bereichen, Geschlechtern, Regionen und Kompetenzen sind willkommen. Das einzige Kriterium ist, dass du leidenschaftlich bist, wenn es darum geht, deine Kreativität einzubringen, um dieses Problem zu lösen.</li><li>Es gibt keine Altersbeschränkung für die Teilnahme am Hackathon. Wenn du unter 18 Jahre alt bist, benötigst du eine unterschriebene Verzichtserklärung der Erziehungsberechtigten, die dich zur Teilnahme am Hackathon berechtigt. </li><Teammitglieder und Mitarbeiter von Preisstiftern sind nicht berechtigt, an den Herausforderungen des Sponsors teilzunehmen. </li><Es gibt keine Länderbeschränkung, aber Sie müssen berechtigt sein, Preise zu erhalten (falls Sie gewinnen) und Sie sind für die Zahlung von Steuern auf die Preisgewinne verantwortlich.</li></ul><br/><strong>Aktuell etwas bauen</strong><ul><li>Das ist kein Slidedeck-Hackathon! Erstellt und demonstriert ein funktionierendes Projekt oder einen Prototyp, zeigt uns nicht nur Screenshots und Folien. Ernsthaft, du wirst den Hackathon nicht gewinnen, indem du ein gefälschtes Mock-up baust.</ul><br/><strong>Schreiben Sie Ihren Code hier</strong>.<ul><li>Das Projekt, das Sie präsentieren, muss während des Hackathons vollständig programmiert sein. Ausgenommen sind nur öffentlich zugängliche Frameworks/APIs und Open-Source-Code, der seit mindestens einem Monat verfügbar ist. Wenn es sich unsicher anfühlt, den Code zu verwenden, tun Sie es nicht.</li></ul><br/><strong>Teambildung</strong><ul><li>Teams können drei bis sieben Mitglieder umfassen.</li><li>Teams sollten Mitglieder mit unterschiedlichen Fähigkeiten (Entwickler, Designer) und Fähigkeiten (Anfänger, Mittelstufe, Experte) haben.<li>Teams müssen bis Mitternacht am ersten Tag des Hackathons, Freitag, den 25. Oktober, eingereicht werden.<li>Teams können sich bei mehr als einer Challenge-Kategorie anmelden, aber wir empfehlen, dass Sie sich auf eine einzige Kategorie konzentrieren und sich nur für eine Kategorie anmelden!</li></ul><br/><strong>Verhalten</strong><ul><li>Das ist auf jeden Fall die wichtigste Regel. Dies ist ein sehr vielfältiges Umfeld, das sich aus vielen Rassen, Religionen, sexuellen Orientierungen, Geschlechtern und Geschlechtsidentitäten zusammensetzt. </li><li>Jedes Verhalten oder jede Präsentation, die andere objektiv oder herabwürdigt, wird gestoppt, wobei die Moderatoren sofort disqualifiziert und aus der Veranstaltung entfernt werden.Seid respektvoll und freundlich zu anderen. Beleidigt oder macht andere Teilnehmer nicht runter. Benimmt euch professionell. Denkt daran, dass Belästigung und rassistische, sexistische oder ausschließende Witze für dieses Ereignis nicht angemessen sind. </li><li>Hab Spaß! Sprechen, arbeiten, verbinden - und lasst euch nicht von der Zeitnot davon abhalten, Spaß zu haben! Bitte denken Sie daran, ab und zu eine Pause zu machen und sich zu entspannen.</li></ul><br/><strong>Code-Prüfungen</strong><ul><li>Teilnehmer werden ihren Code von uns auditieren lassen, um sicherzustellen, dass er neu und legal ist. </Ihr Code gehört Ihnen und wir werden ihn mit niemandem teilen, aber wir werden ihn sehen wollen, wenn Sie gewinnen. Allerdings ist Open Sourcing der Code bei einem Hackathon relativ normal.</li></ul><br/><strong>Versionskontrolle des Codes verwenden</strong><ul><li>Verwenden Sie Git oder ein Äquivalent, um Ihren Code zu verfolgen, während Sie ihn schreiben. Es ist eine gute Praxis, und wenn es zu einem Audit kommt, wird es Ihnen helfen zu beweisen, dass Ihr Code neu ist.</li></ul><br/><strong>Präsentieren Sie das Projekt, das Sie eingereicht haben</strong>.<ul><li>Sie müssen Ihren Hack wie in Ihrer Einreichung beschrieben präsentieren - wenn Sie von Ihrer akzeptierten Einreichung abweichen, müssen wir Sie von der Bühne booten. Reiche nicht eine Sache ein und missbrauche dann die Bühne und den Respekt des Publikums, um etwas anderes zu präsentieren. Denkt an diese Präsentation als Kombination aus Pitch und Live-Demo. Du hast nur 3 Minuten, also beeil dich.</ul><br/><strong>Eigentümerschaft</strong><ul><li>Alle geistigen Eigentumsrechte an den auf der Veranstaltung produzierten Hacks liegen bei den Teilnehmern und nicht bei den Organisatoren, Sponsoren oder Partnern. Die Teams haben die volle Eigentümerschaft an dem, was sie während des Hackathons erstellt haben.</li><Die Sponsoren des Hackathons behalten sich jedoch das Recht vor, Ihre großartige Arbeit auf unserer Website, in Pressemitteilungen, Marketingmaterialien und zur Förderung des Hacks im nächsten Jahr zu präsentieren. (Wir sind hier, um dir zu helfen, nicht um deine Arbeit zu stehlen!).</li></ul>"
          ],
          greenBatch: false
        }
