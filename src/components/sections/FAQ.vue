    ...
    return {
      faqs: [
        ...
        },
        {
          ...
          i18nText: [
            "Tricky question. Grab all you need to work. Most likely your phone, charger, your laptop, charger and some headphones. Bringing toiletries is also a good idea – take your toothpaste, towel, deodorant etc. and extra clothes. If you enjoy napping, don’t forget a throw pillow and a sleeping bag. We will have drinks and food for free at the location, don’t worry. You will also be provided with free internet access.",
            "Knifflige Frage. Schnapp dir alles, was du zur Arbeit brauchst. Höchstwahrscheinlich dein Handy, Ladegerät, dein Laptop, Ladegerät und einige Kopfhörer. Das Mitbringen von Toilettenartikeln ist ebenfalls eine gute Idee - vergesse nicht deine Zahnpasta, Handtuch, Deodorant etc. und zusätzliche Kleidung. Wenn du auch mal schlafen möchtest, vergesse nicht ein Kissen und einen Schlafsack. Wir werden Getränke und Essen kostenlos vor Ort haben, hier also keine Sorge. Außerdem erhältst du einen kostenlosen Internetzugang."
          ],
          greenBatch: false
        },
        {
